<div class="wrap">
    ...
    <form id="adminLoginForm" name="admin_init_form" method="post" action="<?php echo str_replace( '%7E', '~', $_SERVER['REQUEST_URI']); ?>">
        ...
        <p><?php _e( 'admin username: ' ); ?><input type="text" name="username" value="<?php echo $username; ?>" size="15"></p>
        <p><?php _e( 'admin password: ' ); ?><input type="password" name="password" value="<?php echo $password; ?>" size="15"></p>
